...
namespace TavolgaAPI.Migrations
{
    ...
    [Migration("20211204073334_change valuatorbases")]
    partial class changevaluatorbases
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TavolgaAPI.Models.Entityes.Users.BaseUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TavolgaAPI.Models.Entityes.Users.AdminUser", b =>
                {
                    b.HasBaseType("TavolgaAPI.Models.Entityes.Users.BaseUser");
            ...
            modelBuilder.Entity("TavolgaAPI.Models.Entityes.Users.AdminUser", b =>
                {
                    b.HasOne("TavolgaAPI.Models.Entityes.Users.BaseUser", null)
                        .WithOne()
                        .HasForeignKey("TavolgaAPI.Models.Entityes.Users.AdminUser", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TavolgaAPI.Models.Entityes.Users.Contestant", b =>
                {
                    b.HasOne("TavolgaAPI.Models.Entityes.Users.BaseUser", null)
                        .WithOne()
                        .HasForeignKey("TavolgaAPI.Models.Entityes.Users.Contestant", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TavolgaAPI.Models.Entityes.Users.ValuatorBase", b =>
                {
                    b.HasOne("TavolgaAPI.Models.Entityes.Users.BaseUser", null)
                        .WithOne()
                        .HasForeignKey("TavolgaAPI.Models.Entityes.Users.ValuatorBase", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
